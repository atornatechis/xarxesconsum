...
define('HORA_LIMITE_PEDIDO','Hora limit');
...
define('CORRECTO_ANYADIR_U_CONSUMO','La unitat de consum ha sigut desada correctament al grup');
...
define('ERROR_EXISTE_EMAIL','<b>Ja existeix unx usuarix amb aquest email al grup</b>');
...
//MENSAJES
//************************************************************************************************************************************************
define('PRODUCTORX_SOCIX','Productors/es socis/s&ograve;cies');
define('PRODUCTORX_NO_SOCIX','Productors/es no socis/s&ograve;cies');
define('ENERO','GENER');
