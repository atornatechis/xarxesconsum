...
if($mode == 'del'){
	...
	$localitat = mysql_real_escape_string($_POST['localitat']);
	$descripcio = mysql_real_escape_string($_POST['descripcio']);
	$posicio = mysql_real_escape_string($_POST['posicio']);
	$contacte = mysql_real_escape_string($_POST['contacte']);
	$correu = mysql_real_escape_string(decode($_POST['correu']));
