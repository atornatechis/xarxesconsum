...
if( isset($_POST['cancel']) ){
	...
	$consulta_ = "INSERT INTO comanda (data,id_unitat_c,t_producte,t_quantitat,t_pvp,total,observacions) VALUES (NOW(), '".$_SESSION['s_idusuari']."', '".serialize($producte)."', '".serialize($quantitat)."', '".serialize($preu)."', '".(round($total*100)/100)."', '".mysql_real_escape_string( $_POST['observacions'] )."' )";
